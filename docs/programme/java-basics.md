...
* Start reading a book for Java beginners (e.g. Horstmann)
...
* You can read the rest of the book in parallel with going through this course
* Things that you can skip completely:
   ...
   * Streams and closures aren't important unless you want to understand someone else's code that utilizes them. 
...
User creator = new User("project_manager@email.com", "John", "Doe"),
     assignee = new User("developer@email.com", "Jack", "Wolf");
